...
public final class FrozenRecipeProvider extends RecipeProvider {
	private FrozenRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
