...
public final class WindDisturbanceLogic<T> {
	...
	public static void init(RegisterEvent.RegisterHelper<WindDisturbanceLogic<?>> registry) {
		registry.register(DEFAULT_ID, new WindDisturbanceLogic<>(defaultPredicate()));
		registry.register(BREEZE, new WindDisturbanceLogic<>(breeze()));
		registry.register(WIND_CHARGE, new WindDisturbanceLogic<>(windCharge()));
	}
