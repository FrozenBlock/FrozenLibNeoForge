...
public final class SpottingIconPredicate<T extends Entity> {
    ...
    public static void init(RegisterEvent.RegisterHelper<SpottingIconPredicate<?>> registry) {
		registry.register(DEFAULT_ID, new SpottingIconPredicate<>(defaultPredicate()));
    }
}
