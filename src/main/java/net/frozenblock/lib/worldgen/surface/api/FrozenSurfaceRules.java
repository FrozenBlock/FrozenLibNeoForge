...
public final class FrozenSurfaceRules {
	...
	public static SurfaceRules.RuleSource getOverworldSurfaceRules() {
		SurfaceRules.RuleSource newRule;
		ArrayList<SurfaceRules.RuleSource> sourceHolders = new ArrayList<>();

		NeoForge.EVENT_BUS.post(new SurfaceRuleEvent.ModifyOverworld(sourceHolders));
		...
		NeoForge.EVENT_BUS.post(new SurfaceRuleEvent.ModifyOverworldNoPreliminarySurface(noPrelimSourceHolders));
	...
	public static SurfaceRules.RuleSource getNetherSurfaceRules() {
		...
		NeoForge.EVENT_BUS.post(new SurfaceRuleEvent.ModifyNether(sourceHolders));
	...
	public static SurfaceRules.RuleSource getEndSurfaceRules() {
		...
		NeoForge.EVENT_BUS.post(new SurfaceRuleEvent.ModifyEnd(sourceHolders));
	...
	public static SurfaceRules.RuleSource getGenericSurfaceRules(ResourceKey<DimensionType> dimension) {
		...
		NeoForge.EVENT_BUS.post(new SurfaceRuleEvent.ModifyGeneric(sourceHolders));
