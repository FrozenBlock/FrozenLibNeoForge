...
@ApiStatus.Internal
public class BlockSoundGroupManager extends SimplePreparableReloadListener<BlockSoundGroupManager.SoundGroupLoader> {
	...
	@Override
	public SoundGroupLoader prepare(ResourceManager manager, ProfilerFiller profiler) {
		return new SoundGroupLoader(manager, profiler);
	}

	@Override
	public void apply(SoundGroupLoader prepared, ResourceManager manager, ProfilerFiller profiler) {
