...
public final class SoundPredicate<T extends Entity> {
	...
	public static void init(RegisterEvent.RegisterHelper<SoundPredicate<?>> registry) {
		registry.register(DEFAULT_ID, new SoundPredicate<>(SoundPredicate::defaultPredicate));
		registry.register(NOT_SILENT_AND_ALIVE_ID, new SoundPredicate<>(SoundPredicate::notSilentAndAlive));
	}
